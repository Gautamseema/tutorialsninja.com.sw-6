...
public class MyAccountsPage extends Utility {
    ...
    public void callSelectMyAccountOptionMethod() {
        callSelectMyAccountLoginMethod();
    ...
    public void fillInInformation() {
        sendTextToElement(firstName, "Alex");
        sendTextToElement(lastName, "Wood");
        sendTextToElement(email, "AlexW123@gmail.com");
        sendTextToElement(telephone, "078234567");
        sendTextToElement(password, "Wood123");
        sendTextToElement(confirmPassword, "Wood123");
